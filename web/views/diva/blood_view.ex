defmodule Exantenna.Diva.BloodView do
  use Exantenna.Web, :view

  def page_title(:index, assigns), do: gettext("diva blood index page title") <> " - " <> gettext("Default Page Title")
  ...
  def page_description(:index, assigns), do: gettext("diva blood index page title with %{name}", name: gettext("Site Name"))
